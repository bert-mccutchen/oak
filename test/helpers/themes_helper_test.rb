...
class ThemesHelperTest < ActionView::TestCase
  setup do
    @theme_stylesheet_tag =
      "<style type=\"text/css\" id=\"styles_theme_forest\">"\
  ...
  test "should generate a stylesheet tag for a theme" do
    assert_dom_equal @theme_stylesheet_tag, theme_stylesheet_tag(themes(:forest))
  end
end
